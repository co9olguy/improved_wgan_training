...
DATA_DIR = '/home/nkilloran/datasets/RNAcompete/RNCMPT00209/'
if len(DATA_DIR) == 0:
    raise Exception('Please specify path to data directory in gan_language.py!')

BATCH_SIZE = 64 # Batch size
ITERS = 200000 # How many iterations to train for
SEQ_LEN = 41 # Sequence length in characters
DIM = 50 #512 # Model dimensionality. This is fairly slow and overfits, even on
